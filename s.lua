        ...
        Items = {
            SearchTerminal = {
                [[ Terminal doesn't support custom keywords. ]],
                    ...
                    ["Crystal Key"] = {Class = "Misc", Price = "8000"},
                    ["Magic Shard"] = {Class = "Misc", Price = "25000"},
                    ["Tech Key"] = {Class = "Misc", Price = "17500"},
                    ["Golden Prison Key"] = {Class = "Misc", Price = "140000"},
                    ["Spinny Wheel Ticket"] = {Class = "Misc", Price = "1000"},
                    ["Tech Spinny Wheel Ticket"] = {Class = "Misc", Price = "2000"},
                    ["Void Spinny Wheel Ticket"] = {Class = "Misc", Price = "15000"},
                    ["Overload 1"] = {Class = "Charm", Price = "30%"},
                    ["Royalty 1"] = {Class = "Charm", Price = "25%"},
                    ["Exotic Treasure Flag"] = {Class = "Misc", Price = "50000"},
                    ["The Cocktail 1"] = {Class = "Potion", Price = "70000"},
                    ...
                    ["Glitched Drive"] = {Class = "Misc", Price = "1250000"},
