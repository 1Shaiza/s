    ...
    Sniper = {
        ...
        Items = {
            SearchTerminal = {
                ...
                ["The Cocktail"] = {Class = "Potion", Price = "40%"},
                ["Mastery"] = {Class = "XPPotion", Price = "25%"},
                ["Coins 7"] = {Class = "Enchant", Price = "+1%"},
                ["Glitched Drive"] = {Class = "Misc", Price = "35%"},
                ["Super Magnet"] = {Class = "Enchant", Price = "25%"},
                ["Rainbow Eggs"] = {Class = "Enchant", Price = "25%"},
                ["Crystal Key Upper Half"] = {Class = "Misc", Price = "+50%"},
                ["Void Key Upper Half"] = {Class = "Misc", Price = "+50%"},
                ["Tech Key Upper Half"] = {Class = "Misc", Price = "+50%"},
                ["Secret Key Upper Half"] = {Class = "Misc", Price = "+50%"},
                ["Chest Mimic"] = {Class = "Enchant", Price = "25%"},
                ["Hidden Treasure"] = {Class = "Ultimate", Price = "25%"},
                ["Black Hole"] = {Class = "Ultimate", Price = "30%"},
                ["Shiny Apple"] = {Class = "Fruit", Price = "33"},
                ["Shiny Banana"] = {Class = "Fruit", Price = "100"},
                ["Shiny Pineapple"] = {Class = "Fruit", Price = "33"},
                ["Shiny Orange"] = {Class = "Fruit", Price = "75"},
                ["Shiny Watermelon"] = {Class = "Fruit", Price = "100"},
            },
